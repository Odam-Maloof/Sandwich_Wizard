...
class Window(QMainWindow): 
    def __init__(self):
        ...
        # Non-Necessary edits
        # Window Size
        self.setGeometry(50,50,520,450)
        # Window Title
