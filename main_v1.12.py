...
from PyQt5.QtWidgets import QApplication, QMainWindow, QLabel, QComboBox, QPushButton, QGroupBox
...
class Window(QMainWindow): 
    ...
    def extra_salad_swap(self, text):
        remove_blank = self.extro_3.findText('')
        self.extro_3.removeItem(remove_blank)
        print(self.extro_3.findText('bacon'))
